...
3. 记得写清楚 commit message 和 PR 的 title 哦。例如，不要只说「增加/修改/删除一些内容」，而要说，「增加**一位教师的信息及评价**」、「更新**课程大纲**」、「增加**课程建议**」、「修改**学分学时安排**」等。
...
3. 在提交 PR 之前，检查自己的 PR 是否满足以下要求：（可参照 PR 页面的 description）
- 是否在合适的文件夹上传？
  - assignments: 课程作业
