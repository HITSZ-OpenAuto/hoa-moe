...
四六级考试每年进行两次，分别是12月份和6月份，每次考试有2-3套题。每次四六级考试开始报名时，学院都会有通知，切勿错过。

本文主要介绍四、六级 **笔试** 的信息。不过，在此之前，先明确一个问题：

### 要不要报考口试？
四六级中，笔试和口试是两个独立的项目，且口试为选考项目。在报道成绩时，笔试和口试的成绩 **分开报道**：（可以点开[考试大纲](https://cet.neea.edu.cn/res/Home/1704/55b02330ac17274664f06d9d3db8249d.pdf)翻到第212页，看一下四、六级的成绩单长什么样）
...
<center><b>不用报名。</center></b></center>

报名时官网会弹出来口语报名界面，一般来说无需理睬。（当然，假若你决计要报，哈工深本身就是四级、六级口试考点，不用跑去其他地方，这点无需担心。）
...
首先区分两个概念： **原始分和报道分**。原始分，也就是卷面总分，满分是100分；而报道分则是对原始分赋分得到。所谓赋分，就是通过某种原始分和报道分的对应关系，将原始分映射到报道分上的过程，实际上就是函数。
...
{{< callout type="info" >}}
你的报道分数其实只是「你的卷面分在常模群体中排位比例」的反映，也就是说，可以从报道分得出你在全国考生（代表群体）中的**大致**排名情况。也就是说，和卷面分不同，报道分的数字大小本身意义不大，它不过是排名的另一种说法。新高考地区的同学应该较为熟悉这一点。~~当然高考赋分的分数意义重大~~
{{< /callout >}}
...
![6对照表](./六级报道分百分位对照表.png "六级报道分-排位对照表")  

{{% /details %}}

{{< callout type="info" >}}
  其实，此处有关报道分的解释都引用自 [官网分数解释](https://cet.neea.edu.cn/html1/folder/19081/5124-1.htm) ，大家可以去查看，里面有更多例子。
{{< /callout >}}
...
笔者为大一学生，尚未参加六级考试。故以下备考策略主要针对四级。六级备考策略待考后更新。
{{< /callout >}}
...
以4-6套/年（2-3套/次）的出题速度，真题已经足够你找手感、研究了。况且模拟题质量参差不齐，既然有权威优质的真题资源，何必忍受模棱两可的答案呢？若你是大一下及之后参加考试，那么因为学业任务沉重，不可能花太多时间来刷题，就更应该选择真题。
...
### 考试用处
- 四级成绩在425分及以上者才能报考六级。所谓「低分飘过四级」指的是分数在 425 上一点点，并不是”及格“的意思（再次重复，四级其实没有”及格线“一说）。
