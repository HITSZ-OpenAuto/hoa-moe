...
右上角的小按钮展开之后可以选择忽略0余量课程与忽略冲突课程。否则你可能看到大量你选不了的课程（在跨专业中）。另外点入课程中可以看到一些课程相关的信息，这对于你是否选课很关键。有些课程有70%的考试，而有些课程只需要写论文。这些信息都可以在
...
最后， sso 对登陆次数进行限制。如果你频繁的登陆可能会被封禁。大概频率极限在 10次/分钟。如果请求太多你可能会收到的短信/email：
![ban](images/ban.png)
