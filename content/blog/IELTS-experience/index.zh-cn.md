...
对于阅读，我认为做题方法论还是非常重要的，刘洪波的做题思路和技巧我比较同意，例如真经派的做题方式是一篇文章读完一遍等于做完所有题目（但实操上我确实是做不到，考试的时候还因为一道匹配题根本找不到而破防）因此我做题是跟着他的方法去做的，最后看效果确实很不错。
...
- 最后我由于没有时间，所以没有单独去花时间完整写论文，而是稍加构思便让 GPT 帮我去写剑雅的作文我来背，大家如果对作文有更高的要求不要学我（）

### 口语

口语我认为主要有两点，一是要敢说，二是要会说

对于敢说，大家为了避免在考场上面对白人考官十分紧张一句话也说不出来，有条件的可以找外国朋友去多用英语交流，熟悉一下这个感觉，大家也可以找 GPT 或者豆包的连麦模式进行英语沟通，这些大模型每个月都有不少的免费额度可以使用，在这上面联系口语，一段时间后也会卓有成效。

对于会说，我使用的是同桌英语网站的口语题库里面的答题元素和答题结构，这些部分包含了口语的方法论部分，可以让同学知道面对一个问题如何去组织完整、有深度的回答，同学们可以多记忆方法论、多熟读口语素材，找找完整有深度有思考的口语回答的感觉
...
考场的服务人员一般会用英文对你发指令，如果不明白可以让对方说中文，这个不用在意，不需要在这个方面紧张。进入口语考场后，会先问你的名字以及是学生还是在工作（Part 0），然后是两三个主题的日常问答（Part 1），接下来是 Part 2 的 freestyle 环节。在 Part 2 当中，如果回答的时间短于一分四十秒，便会在 Part 2 环节遭到对方的反问，这不必紧张，是正常流程。Part 2 结束后考官会让你放下纸笔，这个也是正常流程。Part 3 便是对 Part 2 的话题进行深度的问答，同学们可能会遇到越来越深入、越来越长的疑问句，为了避免考官揪着一个问题问，同学们可以尽量将自己的意思一次性讲清楚些，否则可能会被反问。

对于给分情况，亲测 Part 0 开始磕磕盼盼，Part1 由于都是背过的题目所以答的还算通顺，Part 2 由于没有英文说长文的经验所以即使是背过的也说得很杂乱无章，Part3 疯狂 pardon，导致考官一直引导我他的问题是什么，我该怎么回答，应该说哪些方面的话题，还有一个问题很长我也没听清，pardon 了一次直接换了一个很简单的问题，这种情况下可以 5.5，同学们如果不那么狼狈一般都可以 6.0，以满足小分要求。
...
个人认为**非必要不报班**。雅思考试本身费用已较高，报名费超过两千元，成绩复议上千，提前查分也要一百，每一项服务都价格不菲。与其花非常多的前在报班上，不如花点小钱在网站的会员上拿到完整的资料和舒适的模考体验用来自己练习。此外方法论层面的内容如上所说，大部分也都是可以免费获取的，大家可以多利用网络资源。只要规划得当、方法正确，完全可以通过自主学习达到目标分数。
