...
对于给分情况，亲测 Part 0 开始磕磕绊绊，Part1 由于都是背过的题目所以答的还算通顺，Part 2 由于没有英文说长文的经验所以即使是背过的也说得很杂乱无章，Part3 疯狂 pardon，导致考官一直引导我他的问题是什么，我该怎么回答，应该说哪些方面的话题，还有一个问题很长我也没听清，pardon 了一次直接换了一个很简单的问题，这种情况下可以 5.5，同学们如果不那么狼狈一般都可以 6.0，以满足小分要求。
