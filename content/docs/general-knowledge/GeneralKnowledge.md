...
- 王婷
  - 老师人很好，有考勤无提问，考核方式为 70% 作业 +30% 期末报告。适合想水学分和想了解数据分析的人，推荐大一下的学生选择，因为学到的知识可以很快运用到大物实验里（指能看懂前人的速成表并进行调整）。老师会发 PPT，并且允许建议用 AI 来完成作业和报告，因此即便你不是计算机专业的学生，也能够轻松完成。
    > 文 / player，2026-05
...
- 赵柘锦
  - 授课风格：轻松有趣，互动性强，即使是 i 人也不会感觉尴尬，并且有时候分享一些技术知识
  - 具体考核形式：对于繁忙的课表，老师有充足的包容，偶尔会有课堂互动。此外有一篇课程论文，运用上课学到的模型做一篇报告。报告允许使用 AI 辅助完成，完成难度不大。
...
- 曾元，潘泽华
  - 授课风格：比较轻松，老师人很好，平时习惯用雨课堂签到，会有课堂小测但是难度不大（一次好像 3 分）
  - 具体考核方式：小组汇报 + 一篇期末报告，小组汇报主要是选取一篇论文进行讲解，老师要求不高，只要完成了感觉都能给个不错的分数（
    > 文 / lsx，2026-06
...
- 陈廷桂
  ...
  - 具体考核形式：没有签到，但是注意一定要加入课程群，因为有结课 pre 要提前选择好时间，（笔者差点挂掉）具体方式就是一个英语 pre，题目自拟，加上一篇关于环境治理的 AI 学习报告
