...
{{< update-info update_time="2025 年 1 月 19 日" author="OliverWu515" message="将文件扩展名改回 md；修改原先的作业" >}}
...
{{< hoa-filetree/container driveURL="https://open.osa.moe/openauto/AUTO3012" repoURL="https://github.com/HITSZ-OpenAuto/AUTO3012" >}}
  ...
  {{< hoa-filetree/folder name="2024-wjd" date="" state="closed" >}}
    ...
    {{< hoa-filetree/file name="流程图" type="md" size="814 bytes" date="2024/10/27" icon="icons/file.png" url="https://gh.hoa.moe/github.com/HITSZ-OpenAuto/AUTO3012/raw/main/labs/2024-wjd/%E6%B5%81%E7%A8%8B%E5%9B%BE.md" >}}
  {{< /hoa-filetree/folder >}}
  {{< /hoa-filetree/folder >}}
