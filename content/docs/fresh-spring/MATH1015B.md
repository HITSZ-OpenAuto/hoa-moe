...
**高等数学下册**
作者：同济大学数学系 | 出版社：高等教育出版社 | 版本：7 版

**大学数学。工科数学分析下册**
作者：哈尔滨工业大学数学学院 | 出版社：高等教育出版社 | 版本：6 版
...
学习衔接：
由于 微积分 B 和 微积分 A 的学习是一脉贯通的，因此可以移步 [微积分 A]([https://hoa.moe/docs/fresh-autumn/math1015a/](https://hoa.moe/docs/fresh-autumn/math1015a/)) 仓库观看详细的学习指导。
...
{{< /hoa-filetree/folder >}}
{{< hoa-filetree/file name="readme" type="toml" size="6.0 KB" date="2026/01/30" icon="icons/file.png" url="https://gh.hoa.moe/github.com/HITSZ-OpenAuto/MATH1015B/raw/main/readme.toml" >}}
