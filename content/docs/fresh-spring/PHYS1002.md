...
math: true
---
最近由 Maxwell Jay 更新于 2024.5.19，更新内容：新增巨磁阻效应与应用的实验绘图程序等内容；更新 README：添加警告 (#24)

* feat: add 红外波物理特性及其研究 程序

* feat: upload program and report for EXP24

* 新增巨磁阻效应的实验绘图程序与说明

* 更新根目录 README：关于虚拟仿真实验、警告
