...
math: true
---
{{< update-info update_time='2023.12.31' author='longlin li' message='Merge pull request #1 from HITSZ-OpenAuto/MaxwellJay256-patch' >}}该课程属于专业限选课程。21级和22级的限选课学分要求不同。
<br>
