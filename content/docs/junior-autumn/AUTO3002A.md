...
{{< update-info update_time="2026 年 3 月 14 日" author="Jiao Ziang" message="Migrate to new lecturers schema (#53)" >}}
...
![%E5%AE%9E%E9%AA%8C25%](https://img.shields.io/badge/%E5%AE%9E%E9%AA%8C-25%25-wheat)
...
## 教材与参考资料
<!-- TOML-SECTION: title="教材与参考资料" -->

<!-- TOML-ITEM: id="item-教材与参考资料 -1" -->
...
- **步进电机应用技术**（[日]坂本正文 (王自强译) / 科学出版社 / 2010 年版 / textbook）
...
| 隆志力 | PWM | 2 | 很重要，需要理解一个周期 PWM 元件上的电流流向、<br>导通关断与否以及元件的作用。 |
| 隆志力 | 变压器 | 2 | 很重要，学时很少，要记忆的东西却很多。<br>重点在负载运行和空载运行的基本方程和 T 形等效电路。<br>笔记文件夹里的笔记整理得很清楚。 |
| 李建刚 | 课程概述 | 1 | 了解即可。 |
...
| 李建刚 | 三相异步电机的等效电路及运行分析，机械特性和调速运行 | 约 2.5 | 是重点，也是难点！！但是你没看错，2 学时结束了。<br>等效的流程：电路模型 -> 频率归算 -> 绕组归算。<br>**异步电机可以看成“会动的变压器”！**<br>详见 notes 文件夹下异步电机的笔记。<br>考试基本是定性分析，定量分析（计算题）要求不高，难度不超过作业题。 |
| 李建刚 | 单相异步电机的等效电路及运行分析 | 约 0.5 | 需要理解单相异步电机的启动，有小题。 |
| 李建刚 | 小功率同步电机 | 0 | 没时间了，没讲，考试不涉及。 |

> 文 / [Oliver Wu](https://www.github.com/OliverWu515)，2024-02

## 习题答案与注意事项
<!-- TOML-SECTION: title="习题答案与注意事项" -->

<!-- TOML-ITEM: id="item-习题答案与注意事项 -1" -->
