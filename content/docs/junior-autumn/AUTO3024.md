...
本课程是将《自动控制实践 B》中嵌入式（STM32）部分独立出来，从 22 级开始开设。
...
{{< /hoa-filetree/folder >}}
{{< hoa-filetree/file name="readme" type="toml" size="5.9 KB" date="2026/02/08" icon="icons/file.png" url="https://gh.hoa.moe/github.com/HITSZ-OpenAuto/AUTO3024/raw/main/readme.toml" >}}
