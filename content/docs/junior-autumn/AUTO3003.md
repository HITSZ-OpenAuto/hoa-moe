...
{{< update-info update_time="2025 年 1 月 23 日" author="IcyDesert" message="删除仓库文件夹中无意义的 README.md，以 .gitkeep 占位 (#11)" >}}
...
{{< hoa-filetree/container driveURL="https://open.osa.moe/openauto/AUTO3003" repoURL="https://github.com/HITSZ-OpenAuto/AUTO3003" >}}
  ...
  {{< hoa-filetree/folder name="dip_pkg" date="" state="closed" >}}
    {{< hoa-filetree/file name="CMakeLists" type="txt" size="1.6 KB" date="2023/11/06" icon="icons/txt.png" url="https://gh.hoa.moe/github.com/HITSZ-OpenAuto/AUTO3003/raw/main/labs/dip_pkg/CMakeLists.txt" >}}
  {{< /hoa-filetree/folder >}}
  {{< /hoa-filetree/folder >}}
