...
category_arr='mandatory distributional-selective graduate-course undergraduate-graduate-course selective cross-major-selective general-knowledge legacy'
