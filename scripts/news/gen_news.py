        ...
        return yaml.dump(
            {
                ...
                "authors": [
                    {"name": "ChatGPT", "link": "https://github.com/openai", "image": "https://github.com/openai.png"}
                ],
                "excludeSearch": False,
                "draft": False,
            },
...
def main():
    ...
    if filtered_commits:
        ...
        if NEWS_TYPE == "weekly":
            ...
            shutil.move(
                "generated_image.png", f"content/news/weekly/weekly-{display_start_time.date()}/generated_image.png"
            )
            shutil.move(
